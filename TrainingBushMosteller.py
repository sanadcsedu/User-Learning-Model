...
class TrainingBushMosteller:
    ...
    def run_bush_mosteller(self, k, alpha = 0.2):
        # print(alpha)
        ...
        for row in self.cur_data:
            ...
            # Getting the attributes used for Testing on T4
                ...
                if len(states) >= 1:
                    ...
                    rbm.update(list(prev_interactions.queue))
                    # print("Picked Attr: {}".format(picked_attr))
                    # print("Ground: {}".format(test))
...
if __name__ == '__main__':
    ...
    for experiment in range(50):
        ...
        for user in a.users:
            # a.read_data(user)
            a.read_cur_data(user)
            accu = a.run_bush_mosteller(2, 0.2)
            # print("Accuracy: {}".format(accu))
            # break
            avrg_user += accu
        average_precision += (avrg_user / len(a.users))
    average_precision /= 50
    print("P@k for Bush and Mosteller (Individual) = {}".format(average_precision))
